...
def sum_df_to_cvs(path_file_coord, name_cvs, name_cvs_reg):
...
if __name__ == '__main__':
    # sum_df_to_cvs(path_file_coord='C:/Users/1/Desktop/ВКР/Магистерская/data/silicone SPBU/PKD_18.02.22_part/10/test_frames/cap_cut_crop.mp4/',
    #               name_cvs='sum_df.cvs', name_cvs_reg='reg_data.cvs')
